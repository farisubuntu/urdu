...
```html
<div class="mt-1"></div>
    <h2 class="w3-panel w3-pale-red w3-leftbar w3-border-red text-center py-2"><strong>Listening</strong></h2>
    <details class="w3-panel w3-pale-yellowlistening">
...
```html
    ...
    <h2 class="w3-panel w3-pale-red w3-leftbar w3-border-red text-center py-2">Question &amp; Answer</h2>
    <div class="textbox interactive-content"><span class="interactive-content__icon"></span>
     <p><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-pencil-fill"
      ...
      </svg>Click to an view interactive H5P
      here:<br />
